...
<div class="wrapper section">
	...
	<div class="main-txt">
		<h1>Wh<span class="point salary">a</span>t's<br>
		y<span class="point cheese">o</span>ur<br>
		f<span class="point salary">a</span>v<span class="point salmon">o</span>rit<span class="point cheese">e</span>s?
		</h1>
		
		<h2 class="sub-txt">내가 <span class="point cheese">좋아하는</span> 재료들로<br>나만의 <span class="point salmon">POKE</span>를!</h2>
		
		<p>어떤 것들이 준비되어있을까요?<br>당신을 위해 다양하게 준비했어요</p>
	</div>
</div>
<div class="wrapper section">
